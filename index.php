...
if(isset($_REQUEST['login']))
{
    ...
    $fetch_query = mysqli_query($connection, "select * from tbl_employee where username ='$username' and password = '$pwd' and role=0 and status=1");
				...
				<div class="account-box">
                    <form method="post" class="form-signin">
						<div class="account-logo">
                            <h3>Ishvaryam Women Fortunes Foundation</h3>
                        </div>
                        ...
                        <a class="text-info"  href="admin/">Admin Login</a>
