...
$id = $_GET['id'];
$fetch_query = mysqli_query($connection, "select * from tbl_department where department_id='$id'");
...
if(isset($_REQUEST['save-department']))
{
      ...
      $update_query = mysqli_query($connection, "update tbl_department set department_id='$department_id', department_name='$department_name', status='$status' where department_id='$id'");
      if($update_query>0)
      {
                    ...
                    <div class="col-lg-8 offset-lg-2">
                        <form method="post">
                          <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="display-block">Branch Status</label>
